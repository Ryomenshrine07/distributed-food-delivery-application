// Widget tests for CallButton (the tappable call action wired into the
// navigation screen). The url_launcher boundary is mocked via the injectable
// `launcher` so no real platform channel is touched.
//
...
void main() {
  ...
  testWidgets('dials the sanitized number on tap (Req 6.2)', (tester) async {
